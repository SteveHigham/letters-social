...
/**
 * The app component serves as a root for the project and renders either
 * children, the error state, or a loading state
 * @method App
           ...
           .then (res =>
                  {
                      return res.json ().then (posts =>
                                               {
                                                   const links = parseLinkHeader (res.headers.get (
                                                       "Link"));
                                                   this.setState (() => (
                                                       {
                                                           posts: orderBy (
